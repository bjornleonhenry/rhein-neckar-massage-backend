...
class WirechatServiceProvider extends PackageServiceProvider
{
    ...
    public function packageBooted(): void
    {
        ...
        if (class_exists(\Namu\WireChat\WireChatServiceProvider::class)) {
            ...
            if (class_exists(Chats::class)) {
                Livewire::component('wirechat.pages.index', Chats::class);
            }
        ...
        if (! Livewire::isDiscoverable('wirechat.pages.index') && class_exists(Chats::class)) {
            Livewire::component('wirechat.pages.index', Chats::class);
        }
    }
}
